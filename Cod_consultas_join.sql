...
SELECT v.nome_videos, v.autor_video, c.nome_canal FROM videos_canais AS vc JOIN videos AS v ON vc.fk_video = v.id_video
JOIN canais AS c ON vc.fk_canal = c.id_canal;


SELECT * FROM v.nome_videos AS vc INNER JOIN videos AS v ON vc.fk_video = v.id_video
INNER JOIN canais AS c ON vc.fk_canal = c.id_canal;


SELECT * FROM v.nome_videos AS vc OUTER JOIN videos AS v ON vc.fk_video = v.id_video
OUTER JOIN canais AS c ON vc.fk_canal = c.id_canal;

SELECT * FROM v.nome_videos AS vc LEFT OUTER JOIN videos AS v ON vc.fk_video = v.id_video;

SELECT * FROM v.nome_videos AS vc RIGHT OUTER JOIN videos AS v ON vc.fk_video = v.id_video
...
SELECT v.id_video, v.name_video FROM v.nome_videos AS vc LEFT OUTER JOIN videos AS v ON vc.fk_video = v.id_video
UNION
SELECT c.id_canal, c.name_canal FROM RIGHT OUTER JOIN canais AS c ON vc.fk_canal = c.id_canal;